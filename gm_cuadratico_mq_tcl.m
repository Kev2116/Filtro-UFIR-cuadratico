...
function tclCmds = gm_cuadratico_mq_tcl
tclCmds = {
    'do cuadratico_compile.do',...% Compile the generated code
    'vsimulink   work.cuadratico',...% Initiate cosimulation
    'add wave  /cuadratico/clk',...% Add wave commands for chip input signals
    'add wave  /cuadratico/reset',...
    'add wave  /cuadratico/in1',...
    'add wave  /cuadratico/out_rsvd',...% Add wave commands for chip output signals
